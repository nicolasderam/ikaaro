...
class AutoAdd(AutoForm):
    ...
    def get_fields(self):
        ...
        for name in self.fields:
            # Skip location if new_resource is NewResource_Local
            new_resource = getattr(resource, 'new_resource', None)
            if (name == 'location' and new_resource is not None and
                issubclass(new_resource, NewResource_Local)):
                continue
